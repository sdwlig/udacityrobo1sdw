...
'''
Format of test case is [ [[EE position],[EE orientation as
quaternions]],[WC location],[joint angles]] You can generate
additional test cases by setting up your kuka project and running `$
roslaunch kuka_arm forward_kinematics.launch` From here you can adjust
the joint angles to find thetas, use the gripper to extract positions
and orientation (in quaternion xyzw) and lastly use link 5 to find the
position of the wrist center. These newly generated test cases can be
added to the test_cases dictionary.
...
def test_code(test_case):
    ...
    print('Position:', test_case[0][0])
    orientation = Orientation(test_case[0][1])
    print('Orientation:', test_case[0][1])
    WC = Position(test_case[1])
    angles = test_case[2]
    print('Angles:',angles)
